 ...
 */
class get_Container_Private_TwigService extends Braunstetter_MenuBundle_Test_app_src_TestKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Twig/Extension.php';
        ...
        $a->addPath('tests/app/src/Resources/views', '__main__');
        $a->addPath((\dirname(__DIR__, 4).'/src/Resources/views'), 'Menu');
        $a->addPath((\dirname(__DIR__, 4).'/src/Resources/views'), '!Menu');
        ...
        $instance->addExtension(new \Braunstetter\MenuBundle\Twig\Extension(($container->services['Braunstetter\\MenuBundle\\Services\\Menu'] ?? $container->load('getMenuService'))));
